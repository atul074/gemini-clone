    ...
    return (
        <div className="flex flex-col min-h-screen w-full ">
            <div className="flex items-center justify-between text-lg px-5 py-4 text-gray-600">
                <p className="font-bold cursor-pointer" onClick={newChat}>
            ...
            <div className="max-w-3xl mx-auto flex-1 px-4">
                {showResult ? (
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 px-5 ">
                            <div className="bg-gray-100 rounded-lg p-5 cursor-pointer hover:bg-gray-200 " onClick={handleSuggestionsOne}>
                            ...
                            <div className="bg-gray-100 rounded-lg p-5 cursor-pointer hover:bg-gray-200" onClick={handleSuggestionsTwo}>
                            ...
                            <div className="bg-gray-100 rounded-lg p-5 cursor-pointer hover:bg-gray-200" onClick={handleSuggestionsThree}>
                            ...
                            <div className="bg-gray-100 rounded-lg p-5 cursor-pointer hover:bg-gray-200" onClick={handleSuggestionsFour}>
                ...
                <div className="mt-12 px-5  bottom-1 mx-auto ">
                    <div className="flex items-center justify-between gap-4 bg-gray-100 p-4 rounded-full">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {(
                                <img onClick={() => onSent()} src={assets.send_icon} alt="Send icon" className="w-6 cursor-pointer" />
                            )}
                        </div>
                    </div>
